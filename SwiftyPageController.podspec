...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftyPageController.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'alkhokhlov' => 'khokhlo.alexander.cr@gmail.com' }
  ...
  # s.resource_bundles = {
  #   'SwiftyPageController' => ['SwiftyPageController/Assets/*.png']
  # }
